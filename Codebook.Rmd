...
## Project Description
This collection represents data collected from the output of the accelerometer and gyroscope contained within a Samsung Galaxy S smartphone. While the data itself represents a broad collection of activities, a subset of that larger collection data is presented within the tidy data set output by this script. The complete data set is also output separately in case it is needed for further summary.
